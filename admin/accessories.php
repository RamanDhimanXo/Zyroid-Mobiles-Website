...
$search = "";
$where_clauses = ["category = 'ACCESSORIES'"];
...
$count_qr = "SELECT COUNT(*) AS total FROM tb_products $where_sql";
$count_res = mysqli_query($con, $count_qr);
$total_rows = mysqli_fetch_assoc($count_res)['total'];
$total_pages = ceil($total_rows / $limit);

$qr = "SELECT * FROM tb_products $where_sql ORDER BY id DESC LIMIT $offset, $limit";
...
if (isset($_POST['sub'])) {
    ...
    if ($error) {
        ...
        if (mysqli_stmt_num_rows($stmt_check) > 0) {
            ...
            if (isset($_FILES['pic']['name']) && is_array($_FILES['pic']['name'])) {
                foreach ($_FILES['pic']['name'] as $i => $filename) {
            ...
            $nwpro = "INSERT INTO tb_products(product_name, product_price, category, product_des, stocks, product_color, device_storage, product_image, en_des_pro) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                $notif_msg = "New accessory '" . $name . "' has been added.";
...
<head>
    ...
    <title>Accessories Inventory - Zyroid Theme</title>
    ...
    <div class="main-content">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h2 class="h3 fw-bold mb-1">Accessories Inventory</h2>
                    <p class="text-white-50 mb-0">Manage your mobile accessories</p>
                </div>
            </div>
        ...
        <form method="GET" class="d-flex gap-2 mb-4">
            <input type="text" name="search" class="form-control" placeholder="Search accessories..."
                value="<?php echo htmlspecialchars($search); ?>">
            <button type="submit" class="btn btn-primary px-4">Search</button>
            <?php if ($search): ?>
                <a href="accessories.php" class="btn btn-outline-light">Clear</a>
            <?php endif; ?>
        </form>
        ...
        <div class="card">
            <div class="card-body p-0">
                            ...
                            while ($data = mysqli_fetch_assoc($res)) {
                                ...
                                <tr>
                                    <td class="ps-4">
                                        <div class="d-flex align-items-center">
                                            <div
                                                class="product-img d-flex align-items-center justify-content-center me-3 text-secondary bg-dark border border-secondary">
                                                <img src="product_images/<?= $thumb ?>" class="product-img"
                                                    alt="Product Image">
                                            </div>
                                            <div>
                                    ...
                                    <td>
                                        <div class="text-white-50 small"><?= $data['add_product_date'] ?></div>
                                    </td>
                                    <td>
                                        <div class="text-success small fw-bold"><i
                                                class="bi bi-check-circle me-1"></i>Remainings: <?= $data['stocks'] ?></div>
                                    </td>
                ...
                <div
                    ...
                    <div class="text-white-50 small">Showing <?php echo mysqli_num_rows($res); ?> of
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <input type="button" name="cls" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                </div>
                <div class="modal-body">

                    <form method="POST" enctype="multipart/form-data" action="accessories.php">
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="category" class="form-select" required>
                                    ...
                                    while ($cat = mysqli_fetch_assoc($cat_list_qr)) {
                                        $selected = ($cat['cat_name'] == 'ACCESSORIES') ? 'selected' : '';
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="product_color" placeholder="e.g. Black">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label text-white-50">Storage (Optional)</label>
                                <select name="device_storage" class="form-select">
                                    <option value="N/A" class="text-dark">N/A</option>
                            ...
                            <div class="col-12">
                                <label class="form-label text-white-50">Product Image</label>
                                <input type="file" class="form-control" name="pic[]" multiple required>
                            </div>
                            <div class="col-12">
