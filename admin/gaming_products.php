...
if (isset($_POST['sub'])) {
    ...
    if ($error) {
        header("Location: gaming_products.php");
        exit();
    } else {
        ...
        if (mysqli_stmt_num_rows($stmt_check) > 0) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                $notif_msg = "New gaming product '" . $name . "' has been added.";
...
<head>
    ...
    <title>Gaming Inventory - Zyroid Theme</title>
    ...
    <div class="main-content">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h2 class="h3 fw-bold mb-1">Gaming Products</h2>
                    <p class="text-white-50 mb-0">Manage your Gaming inventory</p>
                </div>
            </div>
        ...
        <form method="GET" class="d-flex gap-2 mb-4">
            <input type="text" name="search" class="form-control" placeholder="Search Gaming Products..."
                value="<?php echo htmlspecialchars($search); ?>">
            <button type="submit" class="btn btn-primary px-4">Search</button>
            <?php if ($search): ?>
                <a href="gaming_products.php" class="btn btn-outline-light">Clear</a>
            <?php endif; ?>
        </form>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="gaming_products.php">
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="category" class="form-select" required>
                                    ...
                                    while ($cat = mysqli_fetch_assoc($cat_list_qr)) {
                                        $selected = ($cat['cat_name'] == 'GAMING') ? 'selected' : '';
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="device_storage" class="form-select" required>
                                    ...
                                    <option value="128GB" class="text-dark">128GB</option>
                                </select>
                            </div>
                            <div class="col-12">
