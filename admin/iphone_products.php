...
$search = "";
$where_clauses = ["category = 'IPHONES'"];
...
if (isset($_POST['sub'])) {
    ...
    if ($error) {
        header("Location: iphone_products.php");
        exit();
    } else {
...
<head>
    ...
    <title>iPhone Inventory - Zyroid Theme</title>
    ...
    <div class="main-content">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h2 class="h3 fw-bold mb-1">iPhone Products</h2>
                    <p class="text-white-50 mb-0">Manage your iPhone inventory</p>
                </div>
            </div>
        ...
        <form method="GET" class="d-flex gap-2 mb-4">
            <input type="text" name="search" class="form-control" placeholder="Search iPhones..."
                value="<?php echo htmlspecialchars($search); ?>">
            <button type="submit" class="btn btn-primary px-4">Search</button>
            <?php if ($search): ?>
                <a href="iphone_products.php" class="btn btn-outline-light">Clear</a>
            <?php endif; ?>
        </form>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="iphone_products.php">
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="category" class="form-select" required>
                                    ...
                                    while ($cat = mysqli_fetch_assoc($cat_list_qr)) {
                                        $selected = ($cat['cat_name'] == 'IPHONES') ? 'selected' : '';
