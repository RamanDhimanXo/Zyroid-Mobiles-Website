<?php
    ...
    if (isset($_POST['check_email'])) {
        ...
        if (mysqli_num_rows($check) > 0) {
            $show_reset = true;
            $email_val = $email;
            $_SESSION['success'] = "Email verified. You can now reset your password.";
        } else {
    ...
    if (isset($_POST['update_pass'])) {
        $email = mysqli_real_escape_string($con, $_POST['email_hidden']);
        $pass = $_POST['new_pass'];
        ...
        if (strlen($pass) < 6) {
            ...
            if (mysqli_query($con, "UPDATE tb_users SET pass='$hash' WHERE email='$email'")) {
...
<body>
    ...
    <div class="user-card" id="userCard">
        ...
        <div class="text-center mb-5">
            ...
            <p class="text-white-50 small">Secure User Account Retrieval</p>
        </div>
        ...
        <div class="mt-4 d-flex justify-content-between align-items-center px-1">
            <a href="login.php" class="text-white-50 text-decoration-none small hover-link" style="transition:0.3s">
